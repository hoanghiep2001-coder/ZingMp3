...
let Mp3Player = {
  ...
  renderMyPlayListSongs: function () {
    let songs = Home.PlaylistSong[1].map((song, index) => {
      return `
        <div class="song row no-gutters padt8 padb8" data-index="${index}" data-playlist="1">
          <div class="col-lg-6">
          ...
          <div class="col-lg-6">
              <div class="row align-items-center">
                  <div class="col-lg-9">
                      <h3 id="song__album" class="fz-12 lh-40">
                          ${song.album}
                      </h3>
                  </div>
  ...
  renderPersonalArtists: function () {
    let artists = Home.PersonalArtists.map((artist) => {
      return `
        <div class="col-lg-2 artist__card">
        ...
        <div class="col-lg-6">
            <div class="row no-gutters align-items-center">
                ...
                <div class="col-lg-2 position-relative">
                    ...
                    <div class="song__icon position-absolute d-flex">
                        <img src="../Content/image/Icon/icon-playing.gif" class="song__icon-playing playing d-none">
                        <i class="bi bi-play-fill fz-20 ml10 mt8 song__icon-pause text-white d-none"></i>
                    </div>
                </div>
                <div class="col-lg-9">
                    <div class="d-flex flex-column">
